...
export default class Board {
  ...
  toggleLeaderBoardModel() {
    ...
    let model = boardUtil.getLeaderBoardModel();
  ...
  toggleHighScoreModel() {
    const body = boardUtil.getBodyField();
    let model = boardUtil.getHighScoreModel();
  ...
  toggleModelBackground() {
    const body = boardUtil.getBodyField();
    const highScoreModel = boardUtil.getHighScoreModel();
    let modelBackground = boardUtil.getModelBackground();
  ...
  generateHighScoreForm() {
    const model = boardUtil.getHighScoreModel();
  ...
  generateLeaderBoard(sortedHighScores) {
    ...
    const model = boardUtil.getLeaderBoardModel();
